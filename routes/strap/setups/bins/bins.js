...
function getData(req, res) {
    ...
    var sqlStatement = `SELECT * FROM BINS_T WHERE BIN_ID LIKE '${binId}' AND FROM_LOC LIKE '${locId}' AND STATUS LIKE '${status}' AND OWNER LIKE '${owner}' ${partGrp} ${invoice} ${part} ${pallet}`;
    var bindVars = [];
